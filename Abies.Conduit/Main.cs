...
public class Program : Program<Model, Arguments>
{
    ...
    private static (Model model, Command command) GetNextModel(Url url, User? currentUser = null)
    {
        ...
        return currentRoute switch
        {
            ...
            Routing.Route.Login => (new(new Page.Login(new Conduit.Page.Login.Model(CurrentUser: currentUser)), currentRoute, currentUser), Commands.None),
            Routing.Route.Register => (new(new Page.Register(new Conduit.Page.Register.Model(CurrentUser: currentUser)), currentRoute, currentUser), Commands.None),
