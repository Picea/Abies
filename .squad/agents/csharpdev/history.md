...
## Learnings
- 2026-05-06: Migration option 1 branch implementation snapshot: keep direct `Picea` `1.0.0` for non-Glauca projects, and align direct `Picea` in Glauca-coupled projects (`Conduit.Api`, `Conduit.Api.Tests`, `Conduit.ReadStore.PostgreSQL`, `Conduit.ReadStore.PostgreSQL.Tests`) to the Glauca floor (`>= 1.0.27-rc-0002`) to clear `NU1605` downgrade errors.
