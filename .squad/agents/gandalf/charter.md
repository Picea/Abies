...
- **🛑 Pause (if needed):** Surface subjective trade-offs for the user to decide. Fix purely technical issues autonomously.
...
When your plan is approved and ready for execution:
...
3. Tell the coordinator: *"Plan approved. Ready for squad execution. Assign: [agent] → [task], [agent] → [task]."*
