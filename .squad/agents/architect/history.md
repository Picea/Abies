...
- 2026-04-04: User directive supersedes staged convergence for Program-to-Decider: execute full decider migration now, allow breaking changes, and remove temporary compatibility behavior/shims. Migration target is recorded in `.squad/decisions.md` under "2026-04-04T00:00:00Z: Architect — Full Decider Cutover Migration Target (Breaking)" and is the active architecture contract.
