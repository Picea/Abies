...
/// <summary>
/// Shared helper methods for analyzing Picea.Abies.Html element and attribute invocations.
/// </summary>
internal static class AnalysisHelpers
{
    private const string _elementsTypeName = "Picea.Abies.Html.Elements";
    private const string _attributesTypeName = "Picea.Abies.Html.Attributes";

    /// <summary>
    /// Attempts to determine the HTML element name from an invocation expression
    /// that calls a method on Picea.Abies.Html.Elements.
    /// </summary>
