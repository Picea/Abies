 ...
 *
 * @returns {HTMLElement} The debugger mount point.
 */
...
// Initialization is triggered exclusively by mountDebugger().
// There is no module-level auto-initialization; importing this module is side-effect-free.
// The browser runtime (Runtime.cs) calls Interop.MountDebugger() → mountDebugger(),
// which creates the mount point and then calls initializeDebuggerAdapter().
